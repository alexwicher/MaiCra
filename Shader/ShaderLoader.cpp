...
ShaderLoader::ShaderLoader(char *vertPath, char *fragPath, char *geometryPath) {
...
void ShaderLoader::clearProgram() {
    glUseProgram(0);
}

GLuint ShaderLoader::getShaderProgram() const {
    return shaderProgram;
}

void ShaderLoader::setShaderProgram(GLuint shaderProgram) {
...
void ShaderLoader::setVec4(const std::string &name, float x, float y, float z, float w) {
